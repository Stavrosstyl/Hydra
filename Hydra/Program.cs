...
Node Node1 = new Node(Point1, "pinned");
Node Node2 = new Node(Point2, "fixed");
Node Node3 = new Node(Point3);
Node Node4 = new Node(Point4);
//Node Node5 = new Node(Point4, "fixed");
//Node Node6 = new Node(Point4, "pinned");

Console.WriteLine($"\nNode 1 = ({Node1.X}, {Node1.Y}, {Node1.Z}, {Node1.Constraint_Name})");
Console.WriteLine($"Node 2 = ({Node2.X}, {Node2.Y}, {Node2.Z}, {Node2.Constraint_Name})");
Console.WriteLine($"Node 3 = ({Node3.X}, {Node3.Y}, {Node3.Z}, {Node3.Constraint_Name})");
Console.WriteLine($"Node 4 = ({Node4.X}, {Node4.Y}, {Node4.Z}, {Node4.Constraint_Name})");

//Console.WriteLine($"{Node1.Constraint_Fx}{Node1.Constraint_Fy}{Node1.Constraint_Fz}" +
//                  $"{Node1.Constraint_Mx}{Node1.Constraint_My}{Node1.Constraint_Mz}");
//Console.WriteLine($"{Node2.Constraint_Fx}{Node2.Constraint_Fy}{Node2.Constraint_Fz}" +
//                  $"{Node2.Constraint_Mx}{Node2.Constraint_My}{Node2.Constraint_Mz}");
...
//Truss_Element trs_elem_1 = new Truss_Element(Node1, Node2, rect_2cm);
//Truss_Element trs_elem_2 = new Truss_Element(Node1, Node3, rect_2cm);
//Truss_Element trs_elem_3 = new Truss_Element(Node2, Node4, rect_2cm);
//Truss_Element trs_elem_4 = new Truss_Element(Node3, Node4, rect_2cm);
//Truss_Element trs_elem_5 = new Truss_Element(Node1, Node4, rect_2cm);
//Truss_Element trs_elem_6 = new Truss_Element(Node2, Node3, rect_2cm);
